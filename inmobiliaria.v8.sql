...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-04-2024 a las 18:54:34
...
(1, 'Leonel', 'Toloza', '38860057', 'admin@admin.com', '$2a$11$sPtX7Pd4b0E4GfiX6YD34uagKp2mDK4exFQohXN9xO53wvyHqmS4a', 'administrador', 'inmoTL.png', 0, '2024-04-25 08:52:57'),
...
ALTER TABLE `pago`
  ...
  ADD KEY `usuario_creado` (`creado_usuario`),
  ADD KEY `usuario_editado` (`editado_usuario`);
